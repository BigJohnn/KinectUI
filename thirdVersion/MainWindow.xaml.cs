...
//    using Microsoft.Samples.Kinect.WpfViewers;
    ...
    /// </summary>
    public partial class MainWindow : DevComponents.WpfRibbon.RibbonWindow, INotifyPropertyChanged, IDisposable
    {
        #region Parameters
        /// <summary>
        ...
        /// </summary>
        public ColorReconstruction volume;
        ...
        /// </summary>
        private System.Windows.Media.Media3D.Quaternion virtualCameraStartRotation = System.Windows.Media.Media3D.Quaternion.Identity;
        ...
        /// </summary>
        private Microsoft.Kinect.Matrix4 worldToCameraTransform;

        /// <summary>
        /// The default transformation between the world and volume coordinate system
        /// </summary>
        private Microsoft.Kinect.Matrix4 defaultWorldToVolumeTransform;
        ...
        /// </summary>
        private Microsoft.Kinect.Matrix4 worldToBGRTransform = new Microsoft.Kinect.Matrix4();

        /// <summary>
        /// The virtual camera pose - updated whenever the user interacts and moves the virtual camera.
        /// </summary>
        private Microsoft.Kinect.Matrix4 virtualCameraWorldToCameraMatrix4 = new Microsoft.Kinect.Matrix4();
        ...
        /// <summary>
        /// 用来解决View2D&volumeGraphics按钮不协调问题
        /// </summary>
        ...
        public MainWindow()
        {
            ...
            rBRecomstruction.IsEnabled = false;
            rBRstVirtualCamera.IsEnabled = false;
            rBCamera.IsEnabled = false;
            rB3dView.IsEnabled = false;
            rBCaptureColor.IsEnabled = false;
            rBMD.IsEnabled = false;
            rBNearMode.IsEnabled = false;
            rBProgress.IsEnabled = false;
            rBPsInteg.IsEnabled = false;
            rBVolGraph.IsEnabled = false;
        ...
        /// <summary>
        /// Gets or sets the timestamp of the current depth frame   时间戳
        /// </summary>
        ...
        public bool KinectView
        {
            ...
            set
            {
                ...
                if (this.kinectView /*&& displayFlag*/)
                {
                ...
                else
                {
                    ...
                    if (this.volumeGraphics/* && displayFlag*/)
                    {
        ...
        public bool VolumeGraphics
        {
            ...
            set
            {
                ...
                if (this.volumeGraphics)
                {
                    ...
                    this.CreateCube3DGraphics(volumeCubeLineColor, LineThickness, new System.Windows.Media.Media3D.Vector3D(0, 0, 0));
        ...
        {
            if (!this.savingMesh&& !this.openningMesh)
            {
                if (null == this.sensor)
                {
        ...
        private void Process()
        {
            ...
            if (null != this.volume && !this.savingMesh &&!this.openningMesh)
            {
                try
                {
        ...
        private bool TrackCameraAlignDepthFloatToReconstruction(bool calculateDeltaFrame, ref Microsoft.Kinect.Matrix4 calculatedCameraPos)
        {
        ...
        /// </summary>
        /// <returns>Returns true if tracking succeeded, false otherwise.</returns>
        private bool TrackCameraAlignPointClouds(ref bool calculateDeltaFrame, ref Microsoft.Kinect.Matrix4 calculatedCameraPose)
        {
            bool trackingSucceeded = false;
            ...
            Microsoft.Kinect.Matrix4 initialPose = calculatedCameraPose;
        ...
        private void TrackCamera()
        {
            ...
            Microsoft.Kinect.Matrix4 calculatedCameraPos = this.worldToCameraTransform;
        ...
        private void SetReferenceFrame(Microsoft.Kinect.Matrix4 pose)
        {
        ...
        private bool FindCameraPoseAlignPointClouds()
        {
            ...
            Microsoft.Kinect.Matrix4 bestNeighborCameraPose = Microsoft.Kinect.Matrix4.Identity;
            ...
            for (int n = 0; n < maxTests; n++)
            {
                ...
                Microsoft.Kinect.Matrix4 poseProposal = neighbors[n];
        ...
        private bool IntegrateData()
        {
            ...
            bool integrateData = !this.trackingFailed && ((!this.cameraPoseFinderAvailable && !this.PauseIntegration)
        ...
        private void RenderReconstruction()
        {
            if (null == this.volume || this.savingMesh || null == this.raycastPointCloudFrame
                || null == this.shadedSurfaceFrame || null == this.shadedSurfaceNormalsFrame||this.openningMesh)
            {
                return;
            }

            // If KinectView option has been set, use the worldToCameraTransform, else use the virtualCamera transform
            Microsoft.Kinect.Matrix4 cameraView = this.KinectView ? this.worldToCameraTransform : this.virtualCameraWorldToCameraMatrix4;
        ...
        private void ResetReconstruction()
        {
            ...
            this.worldToCameraTransform = Microsoft.Kinect.Matrix4.Identity;
            ...
            if (null != this.volume)
            {
                try
                {
                    ...
                    {
                        Microsoft.Kinect.Matrix4 worldToVolumeTransform = this.defaultWorldToVolumeTransform;
        ...
        private bool RecreateReconstruction()
        {
            ...
            try
            {
                ...
                this.worldToBGRTransform = Microsoft.Kinect.Matrix4.Identity;
        ...
        private void CreateCube3DGraphics(System.Windows.Media.Color color, int thickness, System.Windows.Media.Media3D.Vector3D translation)
        {
        ...
        //{
         //   this.HGraphicsViewport.ZoomExtents();
        //}

        private void StartReconstructionButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            rBRecomstruction.IsEnabled = true;
            rBRstVirtualCamera.IsEnabled = true;
            rBCamera.IsEnabled = true;
            rB3dView.IsEnabled = true;
            rBCaptureColor.IsEnabled = true;
            rBMD.IsEnabled = true;
            rBNearMode.IsEnabled = true;
            rBProgress.IsEnabled = true;
            rBPsInteg.IsEnabled = true;
            rBStop.IsEnabled = true;
            rBVolGraph.IsEnabled = true;
        }
        ...
        private void StopClick(object sender, RoutedEventArgs e)
        {
            ...
            // Stop worker thread
            this.StopWorkerThread();
            this.shadedSurfaceImage.Source = null;
            this.depthFloatImage.Source = null;
            this.deltaFromReferenceImage.Source = null;
        }
    }
